...
export default function AppPage(){
  ...
  /* ------------------ Lifecycle ------------------ */
  useEffect(()=>{ if(tab==="items") loadItems(); if(tab==="feed") loadFeed(); if(tab==="friends" || tab==="dms") loadFriends(); if(tab==="goals"){ loadGoals(); loadAchievements(); } },[tab]);
  useEffect(()=>{ loadItems(); },[]);
    ...
    <div className="container">
      ...
      {tab==="goals" && (
        <section className="card">
          ...
          <h3 className="muted" style={{marginTop:10}}>Tus metas</h3>
          <ul className="list">
            {goals.map(g=> (
            ...
            {!goals.length && <li className="item"><span className="muted">Aún no tienes metas personales.</span></li>}
          </ul>

          <div className="hr" />

          <h3 className="muted" style={{marginTop:10}}>Logros</h3>
          <ul className="list">
            {ach.map(a => (
            ...
            {!ach.length && <li className="item"><span className="muted">Sin logros definidos.</span></li>}
          </ul>
        </section>
      )}
